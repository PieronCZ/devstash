...
- Item card data should not display the content as it can be very long. It shloud display only title, description, tags, etc. but not the actual content. See data fetching below.
