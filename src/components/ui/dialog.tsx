...
// Scrollable middle region. Keeps the header and footer pinned while long content
// scrolls between them (the DialogContent is a flex column capped to the
// viewport). Breaks out to the content edges so the scrollbar sits at the edge,
// then re-adds the horizontal padding so fields stay aligned with the header.
